# Vendored from fla.ops.common.chunk_h (forward-only, inference path)
...
from sglang.srt.layers.attention.fla.index import prepare_chunk_offsets
...
def chunk_fwd_h(
    ...
    chunk_fwd_kernel_h[grid](
        k=k, v=v, h=h,
        g=g, g_gamma=g_gamma, gk=gk, gv=gv,
        h0=h0, ht=ht,
