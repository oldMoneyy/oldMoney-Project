...
export SGLANG_SERVER_ARGS="--quantization modelopt --trust-remote-code --disable-radix-cache --attention-backend flashinfer --chunked-prefill-size 32768 --max-running-requests 64 --max-mamba-cache-size 64 --log-level info --mem-fraction-static 0.82 --enable-torch-compile"
