...
struct BlockInfo {
    ...
    __device__ BlockInfo(const Params &params, const int bidb)
        ...
        , sum_s_v(!Varlen || params.cu_seqlens_v == nullptr || !params.is_seqlens_v_cumulative ? -1 : params.cu_seqlens_v[bidb])
    ...
    template <typename index_t>
    __forceinline__ __device__ index_t v_offset(const index_t batch_stride, const index_t row_stride, const int bidb) const {
