...
class ServerArgs:
    ...
    kv_cache_fp8_layers: Optional[str] = None
    kv_cache_fp4_compress: bool = False
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            type=str,
            default=None,
            help="Comma-separated layer indices to keep at FP8 when using fp4_e2m1 kv-cache-dtype. Example: '0,1,2,38,39' or path to JSON with fp8_layers key.",
        )
        parser.add_argument(
            "--kv-cache-fp4-compress",
            action="store_true",
            default=False,
            help="Store KV cache in FP4 internally while presenting FP8 to attention backend. Use with --kv-cache-dtype fp8_e4m3 --attention-backend flashinfer.",
        )
        parser.add_argument(
            "--enable-fp32-lm-head",
            action="store_true",
