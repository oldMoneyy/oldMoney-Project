...
echo "===== INSTALL TORCH ====="
uv pip install --python /opt/oldMoney-Project/quantization/nvfp4_venv https://download.pytorch.org/whl/cu128/torch-2.8.0%2Bcu128-cp310-cp310-manylinux_2_28_x86_64.whl
...
' > /opt/oldMoney-Project/logs/GPTQ_INT4_env.log 2>&1 &