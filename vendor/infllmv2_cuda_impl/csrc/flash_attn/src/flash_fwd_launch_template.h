            ...
            constexpr static bool Is_local = false; { // TODO remove debug info
                BOOL_SWITCH(params.num_splits > 1, Split, [&] {
                    BOOL_SWITCH(params.knew_ptr != nullptr, Append_KV, [&] {
                        ...
                        constexpr static bool Has_alibi = false; { // TODO remove debug info
                            // SOFTCAP_SWITCH(params.softcap > 0.0, Is_softcap, [&] {
                            constexpr static bool Is_softcap = false; { // TODO remove debug info
        ...
        EVENK_SWITCH(is_even_K, IsEvenKConst, [&] {
            ...
            constexpr static bool Is_local = false; { // TODO remove debug info
                ...
                constexpr static bool Split = false; { // TODO remove debug info
                    // BOOL_SWITCH(params.knew_ptr != nullptr, Append_KV, [&] {
                    constexpr static bool Append_KV = false; { // TODO remove debug info
                        // ALIBI_SWITCH(params.alibi_slopes_ptr != nullptr, Has_alibi, [&] {
                        constexpr static bool Has_alibi = false; { // TODO remove debug info
                            // SOFTCAP_SWITCH(params.softcap > 0.0, Is_softcap, [&] {
                            constexpr static bool Is_softcap = false; { // TODO remove debug info
...
void run_mha_fwd_hdim64(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        if constexpr(!Is_dropout) {
            ...
            run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 16, 64, 1, false, false, T>, Is_dropout, Is_causal>(params, stream);
